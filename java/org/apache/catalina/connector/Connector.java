...
public class Connector extends LifecycleMBeanBase {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        super.initInternal();
        /**
         * 把一个connect绑定一个coyoteAdapt
         */
        adapter = new CoyoteAdapter(this);
        /**
         * protocolHandler 绑定了CoyoteAdapter
         *
         * 所以一个service对应一个connect,对应一个protocolHandler,对应一个CoyoteAdapter
         */
        ...
        try {
            /**
             * protocol 对象在实例化构造中,绑定了endPoint.
             * 这里的初始化需要完成protocol 和 endpoint的初始化
             * endpoint的初始化过程中完成sock的初始化,端口绑定
             */
